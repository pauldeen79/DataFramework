...
public static partial class DataObjectInfoBuilderExtensions
{
    ...
    public static DataObjectInfoBuilder AddAddStoredProcedureStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddAddStoredProcedureStatements(statements.Select(x => new LiteralSqlStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddUpdateStoredProcedureStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddUpdateStoredProcedureStatements(statements.Select(x => new LiteralSqlStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddDeleteStoredProcedureStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddDeleteStoredProcedureStatements(statements.Select(x => new LiteralSqlStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
