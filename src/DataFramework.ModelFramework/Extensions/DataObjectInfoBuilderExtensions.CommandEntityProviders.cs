...
public static partial class DataObjectInfoBuilderExtensions
{
    ...
    public static DataObjectInfoBuilder AddAddResultEntityStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddAddResultEntityStatements(statements.Select(x => new LiteralCodeStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddUpdateResultEntityStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddUpdateResultEntityStatements(statements.Select(x => new LiteralCodeStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddDeleteResultEntityStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddDeleteResultEntityStatements(statements.Select(x => new LiteralCodeStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddAddAfterReadStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddAddAfterReadStatements(statements.Select(x => new LiteralCodeStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddUpdateAfterReadStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddUpdateAfterReadStatements(statements.Select(x => new LiteralCodeStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
    ...
    public static DataObjectInfoBuilder AddDeleteAfterReadStatements(this DataObjectInfoBuilder instance, params string[] statements)
        => instance.AddDeleteAfterReadStatements(statements.Select(x => new LiteralCodeStatement(x, Enumerable.Empty<global::ModelFramework.Common.Contracts.IMetadata>())).ToArray());
}
