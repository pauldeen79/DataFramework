...
namespace DataFramework.ModelFramework.Poc.PagedDatabaseCommandProviders
{
    ...
    public partial class ExtraFieldIdentityDatabaseCommandProvider : PagedSelectDatabaseCommandProviderBase<ExtraFieldQueryProcessorSettings>, IPagedDatabaseCommandProvider<ExtraFieldIdentity>
    {
        ...
        public IPagedDatabaseCommand CreatePaged(ExtraFieldIdentity source, DatabaseOperation operation, int offset, int pageSize)
        {
            if (operation != DatabaseOperation.Select)
            {
                throw new ArgumentOutOfRangeException(nameof(operation), "Only Select operation is supported");
